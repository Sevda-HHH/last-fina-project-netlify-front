...
export const AddBlogDialog: React.FC<IProps> = ({ handleAddBlogClose, handleAddBlogOpen, addBlogOpen }) => {
    ...
    return (
        <div>
            <Dialog fullScreen open={addBlogOpen} onClose={handleAddBlogClose} TransitionComponent={Transition}>
                ...
                <div className="container  mt-5 blogsForm" >
                    <div className="title">
                        <h3>
                            Add A Blog ))
                        </h3>
                        ...
                        <Formik
                            ...
                            onSubmit={async (values) => {
                                ...
                                if (filee) {
                                    ...
                                    await addBlog(formData)(dispatch).then(() => handleAddBlogClose())
                                    Swal.fire(
                                        'Good job!',
